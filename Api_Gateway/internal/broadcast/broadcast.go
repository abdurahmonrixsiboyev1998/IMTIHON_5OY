...
import (
	email1 "api_geteway/internal/email"
	"api_geteway/internal/kafka/producer"
	"api_geteway/internal/models"
	"api_geteway/internal/protos/booking"
	"api_geteway/internal/protos/hotel"
	"api_geteway/internal/protos/user"
	jwttoken "api_geteway/internal/jwt"
	redismethod "api_geteway/internal/redis/method"
	"context"
	"encoding/json"
	"errors"
	"fmt"
