...
import (
	...
	notificationss "booking_service/pkg/protos/notification"
...
func (u *Adjust) CheckUser(ctx context.Context, req *booking.BookHotelRequest) (string, error) {
	...
	if res.Age < int32(18) {
		_, err = u.N.Notification(ctx, &notificationss.ProduceMessage{UserId: req.UserID, Message: "you must be older than 20 years old to get a room"})
		if err != nil {
			log.Println(err)
		}
